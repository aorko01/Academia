...
malloc(uint nbytes)
{
 ...
 9f4:	61053503          	ld	a0,1552(a0) # 1000 <freep>
 ...
 a20:	5e448493          	addi	s1,s1,1508 # 1000 <freep>
  if(p == (char*)-1)
 a24:	5afd                	li	s5,-1
 ...
 a34:	9e078793          	addi	a5,a5,-1568 # 1410 <base>
 ...
 aa6:	54a73f23          	sd	a0,1374(a4) # 1000 <freep>
      return (void*)(p + 1);
